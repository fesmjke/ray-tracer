...
fn main() {
    ...
    let lower_left_corner = origin - horizontal/2.0 - vertical/2.0 - Vec3::new(0f32,0f32,focal_length);
    ...
    for j in (0..image_height).rev(){
        ...
        for i in 0..image_width {
            ...
            let ray = Ray::ray(origin,lower_left_corner + u*horizontal + v*vertical - origin);
